...
<head>
    @include('templates.partials.dokter._head')
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Sidebar  -->
        @include('templates.partials.dokter._sidebar')
        <!-- end Sidebar -->
        ...
        <div id="content-page" class="content-page">
            ...
            <!-- TOP Nav Bar -->
            @include('templates.partials.dokter._navbar')
            <!-- TOP Nav Bar END -->
            ...
            <!-- Footer -->
            @include('templates.partials.dokter._footer')
            <!-- Footer END -->
        </div>
    </div>
    <!-- Wrapper END -->
    ...
    @include('templates.partials.dokter._script')
