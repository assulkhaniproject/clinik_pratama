...
<head>
    @include('templates.partials.medis._head')
</head>
...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- Sidebar  -->
        @include('templates.partials.medis._sidebar')
        <!-- end Sidebar -->
        ...
        <div id="content-page" class="content-page">
            ...
            <!-- TOP Nav Bar -->
            @include('templates.partials.medis._navbar')
            <!-- TOP Nav Bar END -->
            ...
            <!-- Footer -->
            @include('templates.partials.medis._footer')
            <!-- Footer END -->
        </div>
    </div>
    <!-- Wrapper END -->
    ...
    @include('templates.partials.medis._script')
