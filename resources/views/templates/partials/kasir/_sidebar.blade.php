   ...
   <div id="sidebar-scrollbar">
      <nav class="iq-sidebar-menu">
         <ul id="iq-sidebar-toggle" class="iq-menu">
            ...
            <li @if (Request::is('kasir/reportkeuangan')) class="active" @else class="false" @endif>
               <a href="{{ route('kasir.reportkeuangan.index') }}" class="iq-waves-effect"><i class="ri-calculator-fill"></i><span>Report Keuangan</span></a>
            </li>
