    ...
    <div id="sidebar-scrollbar">
       <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
             ...
             <li @if (Request::is('dokter/dashboard')) class="active" @else class="false" @endif>
                <a href="{{route('dokter.dashboard')}}" class="iq-waves-effect"><i class="ion-home"></i><span>Dashboard</span></a>
             </li>
