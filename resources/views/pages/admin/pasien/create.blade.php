                    ...
                    <div class="iq-card-body">
                        ...
                        <form method="post" action="{{ route('admin.pasien.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_pasien" type="text"
                                    class="form-control {{ $errors->has('kategori_pasien') ? 'is-invalid' : '' }}"
                                    id="kategori">
                            ...
                            <div id="civitas" style="display: none">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="mahasiswa" value="mahasiswa" name="type"
                                                class="custom-control-input">
                                            <label class="custom-control-label" for="mahasiswa"> Mahasiswa</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="pegawai" value="pegawai" name="type"
                                                class="custom-control-input">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="nip_nipy" id="nip_nipy" class="fetch_nip_nipy form-control select2"
                                        data-placeholder="Cari NIM / NIPY"></select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" id="no_identitas_form">
                                ...
                                <input name="no_identitas" type="number"
                                    class="form-control {{ $errors->has('no_identitas') ? 'is-invalid' : '' }}" id="identitas">
                            ...
                            <div class="form-group">
                                ...
                                <input name="usia" type="number"
                                    class="form-control {{ $errors->has('usia') ? 'is-invalid' : '' }}" id="usia">
                                @if ($errors->has('usia'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <select name="golongan_darah" type="text" class="form-control  {{ $errors->has('golongan_darah') ? 'is-invalid' : '' }}" id="gol_darah" required>
                                    <option disabled selected>...</option>
                                    <option>A</option>
                                    <option>B</option>
                                    <option>AB</option>
                            ...
                            <div class="form-group">
                                ...
                                <input name="no_hp" type="number"
                                    class="form-control {{ $errors->has('no_hp') ? 'is-invalid' : '' }}" id="no_hp">
                                @if ($errors->has('no_hp'))
                                    <span class="invalid-feedback" role="alert">
