            ...
            <div class="iq-card-body">
                ...
                <form class="form-horizontal ml-5" action="{{ route('admin.obat.store') }}" method="post"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="kode" type="text"
                                class="form-control ml-3 text-dark {{ $errors->has('kode') ? 'is-invalid' : '' }}"
                                id="email" placeholder="" value="{{ $kodeObat }}" readonly>
                            @if ($errors->has('kode'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input name="jenis" type="text"
                                class="form-control ml-3 text-dark {{ $errors->has('jenis') ? 'is-invalid' : '' }}"
                                id="pwd1" placeholder="">
                            @if ($errors->has('jenis'))
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="aturan_minum" class="ml-3 form-control {{ $errors->has('aturan_minum') ? 'is-invalid' : '' }}" id="aturan_minum" cols="30" rows="3"></textarea>
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-2 align-self-center mb-0 ml-4" for="pwd1">Kadaluarsa Obat
                            :</label>
                        <div class="col-sm-8">
                            <input name="kadaluarsa" type="date"
                                class="form-control ml-3 text-dark {{ $errors->has('kadaluarsa') ? 'is-invalid' : '' }}"
                                id="pwd1" placeholder="">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-sm-2 align-self-center mb-0 ml-4" for="pwd1">Jumlah Stok Obat
                            :</label>
                        <div class="col-sm-8">
                            <input name="stok" type="number"
                                class="form-control ml-3 text-dark {{ $errors->has('stok') ? 'is-invalid' : '' }}"
                                id="pwd1" placeholder="">
                            @if ($errors->has('stok'))
                                <span class="invalid-feedback" role="alert">
