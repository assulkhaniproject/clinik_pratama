...
<head>
    <title>History Data Rekam Medis | KLINIK PRATAMA HB</title>
</head>
@section('content')
                ...
                <div class="iq-card">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title row col-12">
                            <h4 class="card-title">History Data Rekam Medis</h4>
                        </div>
                    </div>
                            ...
                            @foreach ($data as $data)
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.rekamMedik.show', $data->id) }}" type="button"
